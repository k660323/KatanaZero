...
public class AiFlyDeadState : DeadState
{
    public string[] bloodsplat = { "bloodsplat", "bloodsplat2", "bloodsplat3", "bloodsplat4" };
    public AiFlyDeadState(Creature creature, Controller controller) : base(creature, controller)
    {
    }
    ...
    public override void EnterState()
    {
        ...
        GameObject go = Managers.Resource.Instantiate("Prefabs/Effect/FlyBlood");
        ...
        creature.GetAnimator.SetBool("IsFlyDead", true);
    }
